...
/*
 * EF51 13M 촬영?�서 zoom ?�과가 비주기적?�로 ?�용?��? ?�았??문제 ?�정
 */
 ...
 * Added By : lee junhee
 ****************************************************************/
#if defined(F_PANTECH_CAMERA_EF48S_49K_50L)
#define F_PANTECH_CAMERA_FIX_CAM_AUDIO_SYNC
#endif

/****************************************************************
 * Description : EF51 series Issue.
 Fix kernel crash  during VT.
 This issue related  case 1642607 Camera patch.
 * Creation Date : 2014/08/11
 * Added By : kim seoyoung
 ****************************************************************/
#define F_PANTECH_CAMERA_VT_KERNEL_CRASH_PATCH
...
/*
 * 13M 촬영 ??zoom ??매우 ?�게 ?�용 ????카메???�기??문제 SR ???�해 ?�정
 */
